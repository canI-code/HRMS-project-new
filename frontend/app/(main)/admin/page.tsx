        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`rounded-lg px-4 py-2 text-sm font-semibold transition ${activeTab === "organization"
                ? "bg-black text-white"
            ...
            <button
              ...
              className={`rounded-lg px-4 py-2 text-sm font-semibold transition ${activeTab === "roles"
                ? "bg-black text-white"
                : "border border-zinc-200 text-zinc-800 hover:bg-zinc-100"
                }`}
            >
            ...
            <button
              ...
              className={`rounded-lg px-4 py-2 text-sm font-semibold transition ${activeTab === "audit"
                ? "bg-black text-white"
                : "border border-zinc-200 text-zinc-800 hover:bg-zinc-100"
                }`}
            >
