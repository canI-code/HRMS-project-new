      ...
      <Protected roles={["hr_admin", "super_admin"]}>
        <AppShell>
          <div className="space-y-6 p-6">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.08em] text-zinc-500">Payroll</p>
              <h1 className="text-2xl font-semibold text-zinc-900">Payroll Reports</h1>
              <p className="text-sm text-zinc-600">View summary and department-wise payroll analytics</p>
            </div>
